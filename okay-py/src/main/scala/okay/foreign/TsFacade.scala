 ...
 *
 * {{{
 * sbt "okayPy/runMain okay.foreign.TsFacade <dir> shop Shop my.pkg my.model.*"
 * }}}
 */
object TsFacade:
  ...
  def render(obj: String, pkg: String, module: String, dts: String, imports: Seq[String] = Nil): Either[String, String] =
    ...
    yield
      ...
      b ++= s"\n// Generated by okay.foreign.TsFacade from the TypeScript module `$module`: regenerate it, do not edit it.\n"
      data.foreach(d => b ++= s"\n$d\n")
      b ++= s"\nobject $obj:\n"
      for f <- methods do
        b ++= "\n"
