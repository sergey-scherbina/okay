...
TypeScript (`TsModule`) and compiled Go, Rust and Haskell workers
(`WorkerModule`) take the same stage since foreign-more-languages
([okay-foreign-cluster](okay-foreign-cluster.md)). Clojure and Frege
