...
object IntentFixture {
  ...
  val languages: List[String] = List("en", "fr", "de", "es", "ru", "ja", "uk", "pl")
  ...
  val parallel: List[Parallel] = List(
    Parallel("meet-tuesday", "Proposal", Map(
      ...
      "ja" -> "火曜日の15時に会えますか？",
      "uk" -> "Можемо зустрітися у вівторок о 15:00?",
      "pl" -> "Czy możemy spotkać się we wtorek o 15:00?")),
    Parallel("move-review", "Proposal", Map(
      ...
      "uk" -> "Пропоную перенести рев'ю на наступний тиждень.",
      "pl" -> "Proponuję przełożyć przegląd na przyszły tydzień.")),
    Parallel("friday-call", "Proposal", Map(
      ...
      "uk" -> "Чи підійде вам короткий дзвінок у п'ятницю вранці?",
      "pl" -> "Czy piątek rano pasuje na krótką rozmowę?")),
    Parallel("send-agenda", "Request", Map(
      ...
      "ja" -> "会議の前に議題を送ってください。",
      "uk" -> "Надішліть, будь ласка, порядок денний до зустрічі.",
      "pl" -> "Proszę przesłać mi agendę przed spotkaniem.")),
    Parallel("book-room", "Request", Map(
      ...
      "uk" -> "Заброньте, будь ласка, кімнату на чотирьох.",
      "pl" -> "Czy mogłabyś zarezerwować salę dla czterech osób?")),
    Parallel("confirm-attend", "Request", Map(
      ...
      "ja" -> "ご出席いただけるかご確認ください。",
      "uk" -> "Підтвердьте, будь ласка, чи зможете бути присутні.",
      "pl" -> "Proszę potwierdzić, czy będziesz obecna.")),
    Parallel("room-changed", "Notification", Map(
      ...
      "ja" -> "会議室がB2に変更されました。",
      "uk" -> "Зустріч перенесено до кімнати B2.",
      "pl" -> "Spotkanie przeniesione do sali B2.")),
    Parallel("on-leave", "Notification", Map(
      ...
      "ja" -> "来週は休暇を取ります。",
      "uk" -> "Наступного тижня я буду у відпустці.",
      "pl" -> "W przyszłym tygodniu będę na urlopie.")),
    Parallel("call-cancelled", "Notification", Map(
      ...
      "uk" -> "Завтрашній дзвінок скасовано, робити нічого не треба.",
      "pl" -> "Jutrzejsza rozmowa jest odwołana, nic nie trzeba robić.")),
    Parallel("birthday", "Other", Map(
      ...
      "uk" -> "З днем народження! Гарного дня.",
      "pl" -> "Wszystkiego najlepszego! Miłego dnia.")),
    Parallel("charged-twice", "Other", Map(   // HARD: a Request in register
      ...
      "uk" -> "З моєї картки списали двічі, прошу повернути кошти.",
      "pl" -> "Z mojej karty pobrano dwa razy, proszę o zwrot.")),
    Parallel("app-crashes", "Other", Map(   // HARD: a support issue
      ...
      "uk" -> "Застосунок падає, коли я відкриваю сторінку оплати.",
      "pl" -> "Aplikacja się zawiesza, gdy otwieram stronę płatności.")),
    Parallel("propose-earlier", "Proposal", Map(
      ...
      "ja" -> "会議を1時間早く始められますか。",
      "uk" -> "Може, почнемо зустріч на годину раніше?",
      "pl" -> "Może zaczniemy spotkanie godzinę wcześniej?")),
    Parallel("propose-split", "Proposal", Map(
      ...
      "uk" -> "Давайте розділимо це на дві коротші сесії.",
      "pl" -> "Podzielmy to na dwie krótsze sesje.")),
    Parallel("propose-weekly", "Proposal", Map(
      ...
      "ja" -> "毎週月曜日に定例を追加しませんか。",
      "uk" -> "Може, додамо щотижневу зустріч щопонеділка?",
      "pl" -> "Może dodamy cotygodniowe spotkanie w poniedziałki?")),
    Parallel("propose-after", "Proposal", Map(
      ...
      "uk" -> "Як щодо того, щоб зустрітися після релізу?",
      "pl" -> "A może spotkajmy się po wydaniu?")),
    Parallel("request-slides", "Request", Map(
      "en" -> "I need the slides by Thursday.",
      "fr" -> "Merci d'envoyer les diapositives avant jeudi.",
      "de" -> "Die Folien brauche ich bis Donnerstag.",
      "es" -> "Necesito las diapositivas para el jueves.",
      "ru" -> "Слайды нужны мне к четвергу.",
      "ja" -> "木曜日までにスライドを送ってください。",
      "uk" -> "Слайди потрібні мені до четверга.",
      "pl" -> "Slajdy są mi potrzebne przed czwartkiem.")),
    Parallel("request-invite", "Request", Map(
      ...
      "ja" -> "私も招待に入れてください。",
      "uk" -> "Додайте мене, будь ласка, до запрошення.",
      "pl" -> "Dodaj mnie proszę do zaproszenia.")),
    Parallel("request-notes", "Request", Map(
      ...
      "ja" -> "今回は議事録をお願いします。",
      "uk" -> "Ведіть, будь ласка, протокол цього разу.",
      "pl" -> "Proszę tym razem sporządzić notatki.")),
    Parallel("request-room", "Request", Map(
      ...
      "uk" -> "Чи вільна кімната — можете глянути?",
      "pl" -> "Sprawdź proszę, czy sala jest wolna.")),
    Parallel("notify-late", "Notification", Map(
      ...
      "ja" -> "10分ほど遅れます。",
      "uk" -> "Я запізнюся на десять хвилин.",
      "pl" -> "Spóźnię się o dziesięć minut.")),
    Parallel("notify-agenda", "Notification", Map(
      ...
      "ja" -> "議題が更新されました。",
      "uk" -> "Порядок денний оновлено.",
      "pl" -> "Agenda została zaktualizowana.")),
    Parallel("notify-remote", "Notification", Map(
      ...
      "ja" -> "今後、木曜日はリモートになります。",
      "uk" -> "Відтепер по четвергах працюємо віддалено.",
      "pl" -> "Od teraz w czwartki pracujemy zdalnie.")),
    Parallel("notify-recording", "Notification", Map(
      ...
      "ja" -> "昨日の録画が利用可能になりました。",
      "uk" -> "Вчорашній запис уже доступний.",
      "pl" -> "Wczorajsze nagranie jest już dostępne.")),
    Parallel("other-thanks", "Other", Map(
      ...
      "uk" -> "Дякую, це справді допомогло.",
      "pl" -> "Dziękuję, to bardzo pomogło.")),
    Parallel("other-recipe", "Other", Map(
      ...
      "ja" -> "昼食のときに聞かれたレシピです。",
      "uk" -> "Ось рецепт, про який ви питали за обідом.",
      "pl" -> "Oto przepis, o który pytałaś przy obiedzie.")),
    Parallel("other-weather", "Other", Map(
      ...
      "ja" -> "今週末は雪が降るそうです。",
      "uk" -> "Кажуть, на вихідних буде сніг.",
      "pl" -> "Podobno w weekend ma padać śnieg.")),
    Parallel("other-password", "Other", Map(
      ...
      "uk" -> "Моє посилання для скидання пароля вже недійсне.",
      "pl" -> "Mój link do resetu hasła wygasł.")),
    Parallel("other-congrats", "Other", Map(
      ...
      "ja" -> "新しい役職、本当によかったですね。",
      "uk" -> "Вітаю з новою посадою!",
      "pl" -> "Gratulacje z okazji nowego stanowiska!")),
    Parallel("other-delivery", "Other", Map(
      ...
      "ja" -> "注文した品がまだ届きません。",
      "uk" -> "Моє замовлення досі не прийшло.",
      "pl" -> "Moje zamówienie wciąż nie dotarło.")))
